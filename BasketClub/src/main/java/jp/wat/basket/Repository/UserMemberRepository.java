...
public interface UserMemberRepository extends JpaRepository<UserMember, Integer>{
	...
	*/
	...
	public List<UserMember> findById(@Param("userId") String userId);
	...
	*/
	...
	public List<Integer> findByIdNendo(@Param("userId") String userId, @Param("nendo") Integer nendo);
	...
	*/
	...
	public void deleteUserMember(@Param("userId") String userId, @Param("nendo") Integer nendo, @Param("memberId") Integer memberId);
	...
	*/
	...
	public void deleteUserMember(@Param("userId") String userId);
...
//			+ "order by m.nendo asc, m.no asc")
	...
	public List<UserMember> findByUserId(@Param("userId") String userId);
