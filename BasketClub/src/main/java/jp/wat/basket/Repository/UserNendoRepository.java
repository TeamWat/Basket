...
public interface UserNendoRepository extends JpaRepository<UserNendo, Integer>{
	 ...
	 * ユーザーに紐づく年度情報を取得する
	*/
	@Query(value="select nendo from UserNendo m where m.userId = :userId order by m.nendo asc")	    // @Queryの標準の書き方（エンティティクラス名 エンティティクラスのカラム名を使用）
	public List<Integer> findById(@Param("userId") String userId);
	...
	*/
	...
	public void deleteUserNendo(@Param("userId") String userId, @Param("nendo")Integer nendo);
	...
	*/
	...
	public void deleteUserNendo(@Param("userId") String userId);
